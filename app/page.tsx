...
export default function Home() {
  ...
  const filtered = products.filter((p: any) => {
    ...
    const c = cat === "Shop All"? true : cat === "Best Sellers"? p.is_best_seller : p.category === cat || p.category?.toLowerCase().includes(cat.toLowerCase().split(" ")[0].toLowerCase())
    return s && c
  })
  ...
  return (
    <div className="min-h-screen bg-[#E8F5E9]">
      ...
      <section className="max-w-6xl mx-auto p-4 mt-6">
        ...
        {filtered.length === 0 && <p className="text-center text-[#1A3C34]/40 mt-10 text-sm">Admin se product add karo to yahan LIVE ayega — Shop All + Best Sellers me</p>}
      </section>

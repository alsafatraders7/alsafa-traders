...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#E8F5E9]">
      <div className="bg-[#E8F5E9] text-[11px] text-center py-1.5 tracking-widest text-[#1A3C34] font-bold">
      ...
      <header className="bg-[#1A3C34] p-3 flex items-center gap-3 sticky top-0 z-20">
        ...
        <a href="/admin" className="bg-white w-10 h-10 rounded-full flex items-center justify-center">💬</a>
      </header>

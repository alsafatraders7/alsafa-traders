...
export default function AlSafaFinalAdmin(){
  ...
  const syncDarazPrices=async()=>{
    ...
    alert(updated+" Prices 【entity-Daraz¦canonical_name=Daraz】 se Update!")
  }
    ...
    return(
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="bg-white rounded-[28px] p-7 w-full max-w-[400px]">
          ...
          <p className="text-[10px] text-gray-400">{LOCKED_EMAIL} - Real OTP + Auto 【entity-Daraz¦canonical_name=Daraz】</p>
    ...
    <div className="min-h-screen bg-[#F0F5F0]">
      <div className="sticky top-0 bg-white border-b px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={syncDarazPrices} className="bg-[#FFD814] px-4 py-2 rounded-full text-xs font-black">{syncing?"...":"🔄 【entity-Daraz¦canonical_name=Daraz】 Sync"}</button>
